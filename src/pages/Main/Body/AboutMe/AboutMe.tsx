      ...
      <Container>
        ...
        <RightBox>
          <Description>
            ...
            서비스를 초기부터 현재까지 약 2년 간 백앤드 파트를 전담하여
            개발해오고 있습니다.
            <br />
            <br />
            ...
            노력하고 있습니다.
            <br />
            <br />그 외에도 보안과 비용, 성능을 고려한 인프라(AWS), 생산성을
            위한 DevOps 환경, 서비스 운영 안정성을 위한 모니터링 시스템
            구축(ELK) 등에도 힘써왔습니다. 프론트앤드에도 흥미가 있어 사내
            백오피스 툴이나 개인적인 작업물을 이것저것 해보고 있습니다.
          </Description>
        </RightBox>
      </Container>
    </>
